            ...
            <Box className="form">
              <Box style={{ borderBottom: "none" }}>
                ...
                {selectedOption === 1 && (
                  <div>
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="income-description" className="label">
                        gelir tesviri{" "}
                      </label>
                      <TextField
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="income-amount">gelir meblegi</label>
                      <TextField
                        id="income-amount"
                        type="number"
                        name="amount"
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="income-source" className="label">
                        gelir menbeyi
                      </label>
                      <TextField
                        id="income-source"
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="income-username" className="label">
                        {" "}
                        istifadeci adi{" "}
                      </label>
                      <TextField
                ...
                {selectedOption === 2 && (
                  <div>
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="expense-destination" className="label">
                        xərcin təyinatı{" "}
                      </label>
                      <TextField
                ...
                {selectedOption === 3 && (
                  <div>
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="debt-description" className="label">
                        borc tesviri{" "}
                      </label>
                      <TextField
                        id="debt-description"
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="debt-amount" className="label">
                        borc meblegi
                      </label>
                      <TextField
                        id="debt-amount"
                    ...
                    <Box style={{ borderBottom: "none" }}>
                      <label htmlFor="debt-source" className="label">
                        borc menbeyi
                      </label>
                      <TextField
                        id="debt-source"
